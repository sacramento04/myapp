...
-define(INFO(Msg, Args), game_app_log:write(info, Msg, Args)).
-define(ERROR(Msg, Args), game_app_log:write(error, Msg, Args)).
-define(WARNING(Msg, Args), game_app_log:write(warning, Msg, Args)).
